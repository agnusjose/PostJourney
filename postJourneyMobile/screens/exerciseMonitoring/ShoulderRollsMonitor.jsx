...
export default function ShoulderRollsMonitor() {
  ...
  const isHighPriority = (text) => {
    const priorities = [
      "roll", "forward", "backward", "complete", "ready", "lift",
      "rep", "done", "reverse", "great", "good",
    ];
  ...
  useEffect(() => {
    ...
    startWebRTCStream(POSE_API_BASE_URL, "shoulder_rolls", (s) => setLocalStream(s))
      .then((stopFunc) => {
        stopStream = stopFunc;
        setStreamReady(true);
      })
    ...
    <View style={styles.container}>
      ...
      <View style={styles.hudContainer}>
        <View style={styles.feedbackCard}>
          <Text style={styles.title}>SHOULDER ROLLS AI</Text>
