...
export default function PendulumExerciseMonitor() {
  ...
  const isHighPriority = (text) => {
    const priorities = ["circle", "swing", "clockwise", "counterclockwise", "complete", "done", "phase", "pendulum", "forward"];
  ...
  useEffect(() => {
    ...
    if (!highPriority && elapsed < 8000) return;
  ...
  useEffect(() => {
    ...
    let stopStream;
    startWebRTCStream(POSE_API_BASE_URL, "pendulum_exercise", (s) => setLocalStream(s))
    ...
    <View style={styles.container}>
      ...
      <View style={styles.hudContainer}>
        <View style={styles.feedbackCard}>
          <Text style={styles.title}>PENDULUM EXERCISE AI</Text>
