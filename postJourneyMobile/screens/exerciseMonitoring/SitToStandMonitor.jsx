...
export default function SitToStandMonitor() {
  ...
  const isHighPriority = (text) => {
    const priorities = [
      "rep", "done", "push through", "stand up", "sit back", "stand tall",
      "keep rising", "excellent", "complete", "good hold", "lower yourself",
      "ready", "hold", "sit down",
    ];
  ...
  useEffect(() => {
    ...
    startWebRTCStream(POSE_API_BASE_URL, "sit_to_stand", (s) => setLocalStream(s))
      .then((stopFunc) => {
        stopStream = stopFunc;
        setStreamReady(true);
      })
    ...
    <View style={styles.container}>
      ...
      <View style={styles.hudContainer}>
        <View style={styles.feedbackCard}>
          <Text style={styles.title}>SIT TO STAND AI</Text>
