...
export default function QuadricepsSetMonitor() {
  ...
  const isHighPriority = (text) => {
    const priorities = ["tighten", "hold", "relax", "complete", "rep", "done", "contraction", "quad"];
  ...
  useEffect(() => {
    ...
    if (!highPriority && elapsed < 3000) return;
  ...
  useEffect(() => {
    ...
    let stopStream;
    startWebRTCStream(POSE_API_BASE_URL, "quadriceps_set", (s) => setLocalStream(s))
    ...
    <View style={styles.container}>
      ...
      <View style={styles.hudContainer}>
        <View style={styles.feedbackCard}>
          <Text style={styles.title}>QUADRICEPS SET AI</Text>
