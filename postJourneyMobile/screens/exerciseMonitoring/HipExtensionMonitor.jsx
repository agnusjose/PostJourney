...
export default function HipExtensionMonitor() {
  ...
  useEffect(() => {
    ...
    let stopStream;
    startWebRTCStream(POSE_API_BASE_URL, "hip_extension", (s) => setLocalStream(s))
    ...
    <View style={styles.container}>
      ...
      <View style={styles.hudContainer}>
        <View style={styles.feedbackCard}>
          <Text style={styles.title}>HIP EXTENSION AI</Text>
